    ...
    <div className="min-h-screen bg-brand-cream flex">
      ...
      <aside className="w-60 bg-brand-charcoal flex flex-col fixed h-full z-30 border-r border-white/10">
        ...
        <div className="px-3 py-4 border-t border-white/10 space-y-1">
          ...
          <div className="flex items-center gap-3 px-3 py-3 mt-2">
            <div className="w-9 h-9 bg-brand-gold rounded-xl flex items-center justify-center text-xs font-black text-brand-brown flex-shrink-0">
              JD
            </div>
      ...
      <div className="flex-1 ml-60 flex flex-col min-h-screen">
        ...
        <header className="bg-white border-b border-gray-200 px-8 py-4 flex items-center justify-between sticky top-0 z-20">
          <div>
            <h1 className="font-display text-xl font-black text-brand-brown">Dashboard</h1>
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/tool"
              className="flex items-center gap-2 bg-brand-gold hover:bg-brand-gold-light text-brand-brown text-sm font-black uppercase tracking-wider px-5 py-2.5 rounded-full transition-all ml-2"
            >
              <Plus size={16} />
              New Offer Map
            </Link>
        ...
        <main className="flex-1 p-8">
              ...
              return (
                <div key={stat.label} className="bg-white rounded-2xl p-6 border border-gray-200 hover:border-brand-gold hover:shadow-md transition-all">
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-10 h-10 bg-brand-brown rounded-xl flex items-center justify-center">
                      <Icon size={18} className="text-brand-gold" />
                    </div>
                  </div>
                  <div className="text-3xl font-display font-black text-brand-brown mb-1 tracking-tight">{stat.value}</div>
          ...
          <div className="bg-white rounded-2xl border border-gray-200">
            <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
              <h2 className="font-display font-black text-brand-brown">Recent Clients</h2>
                    ...
                    <tr key={client.name} className="hover:bg-brand-cream/40 transition-colors group">
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className="w-9 h-9 bg-brand-brown rounded-xl flex items-center justify-center text-xs font-black text-brand-gold flex-shrink-0">
                            {client.initials}
                          </div>
                          <span className="text-sm font-bold text-brand-brown">{client.name}</span>
                        </div>
                      </td>
                      <td className="px-6 py-4">
          ...
          <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
            {[
              ...
              <div key={action.label} className="bg-white rounded-2xl border border-gray-200 p-5 hover:border-brand-gold hover:shadow-md transition-all">
                <h3 className="font-display font-black text-brand-brown text-sm mb-1">{action.label}</h3>
