    ...
    <div className="min-h-screen bg-brand-cream">
      ...
      <main>
        ...
        <section className="pt-20 pb-16 px-4 text-center bg-brand-cream">
          ...
          <h1 className="font-display text-5xl font-black text-brand-brown mb-4 leading-tight">
            ...
            {moneyModelGoals.map((goal) => {
              ...
              return (
                <div key={goal.label} className="bg-white rounded-2xl p-5 border border-gray-200 text-center hover:border-brand-gold hover:shadow-md transition-all">
                  <div className="w-10 h-10 bg-brand-brown rounded-xl flex items-center justify-center mx-auto mb-3">
                    <Icon size={18} className="text-brand-gold" />
                  </div>
                  <div className="font-display font-black text-brand-brown text-sm mb-1.5">{goal.label}</div>
        ...
        <section className="pb-24 px-4">
          <div className="max-w-2xl mx-auto">
            <div className="rounded-2xl p-10 bg-brand-charcoal ring-2 ring-brand-gold shadow-2xl shadow-black/20 relative">
              <div className="absolute -top-3.5 left-1/2 -translate-x-1/2">
                <span className="bg-brand-gold text-brand-brown text-xs font-black px-5 py-1.5 rounded-full uppercase tracking-widest">
                  Monthly Consulting
                </span>
              </div>
              ...
              <div className="text-center">
                <a
                  ...
                  className="inline-flex items-center justify-center gap-2 font-black uppercase tracking-wider py-4 px-12 rounded-full transition-all text-base bg-brand-gold hover:bg-brand-gold-light text-brand-brown hover:shadow-lg hover:shadow-brand-gold/30 hover:-translate-y-0.5"
                >
                  Apply Now
                  <ArrowRight size={18} />
                </a>
        ...
        <section className="py-20 px-4 bg-white border-t border-gray-200">
          <div className="max-w-3xl mx-auto">
            <h2 className="font-display text-3xl font-black text-brand-brown mb-8 text-center">Who this is for</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div>
                <p className="text-sm font-black text-brand-orange uppercase tracking-wider mb-4">Good fit</p>
                <ul className="space-y-3">
                  {[
                    ...
                    <li key={item} className="flex items-start gap-3 text-sm text-gray-700 font-medium">
                      <CheckCircle2 size={15} className="mt-0.5 flex-shrink-0 text-brand-orange" />
                      {item}
                    </li>
                  ))}
                </ul>
              ...
              <div>
                <p className="text-sm font-black text-gray-400 uppercase tracking-wider mb-4">Not for</p>
                <ul className="space-y-3">
                  {[
